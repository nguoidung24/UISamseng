@php
    $dataMenu = [
        ...
        [
            ...
            'idMessage' => 'beingOrder',
        ],
        // [
        //     'name' => 'Test Menu',
        //     'link' => '/test',
        //     'icon' =>
        //         '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 640 512"><path d="M48 0C21.5 0 0 21.5 0 48V368c0 26.5 21.5 48 48 48H64c0 53 43 96 96 96s96-43 96-96H384c0 53 43 96 96 96s96-43 96-96h32c17.7 0 32-14.3 32-32s-14.3-32-32-32V288 256 237.3c0-17-6.7-33.3-18.7-45.3L512 114.7c-12-12-28.3-18.7-45.3-18.7H416V48c0-26.5-21.5-48-48-48H48zM416 160h50.7L544 237.3V256H416V160zM112 416a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm368-48a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/></svg>',
        //     'idMessage' => '',
        // ],
        [
            'name' => 'Các sản phẩm',
            'link' => '/products',
            'icon' =>
                '<svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="20" width="20" xmlns="http://www.w3.org/2000/svg"> <path        d="M2.97 12.92A2 2 0 0 0 2 14.63v3.24a2 2 0 0 0 .97 1.71l3 1.8a2 2 0 0 0 2.06 0L12 19v-5.5l-5-3-4.03 2.42Z">     </path>     <path d="m7 16.5-4.74-2.85"></path>     <path d="m7 16.5 5-3"></path>     <path d="M7 16.5v5.17"></path>     <path         d="M12 13.5V19l3.97 2.38a2 2 0 0 0 2.06 0l3-1.8a2 2 0 0 0 .97-1.71v-3.24a2 2 0 0 0-.97-1.71L17 10.5l-5 3Z">     </path>     <path d="m17 16.5-5-3"></path>     <path d="m17 16.5 4.74-2.85"></path>     <path d="M17 16.5v5.17"></path>     <path d="M7.97 4.42A2 2 0 0 0 7 6.13v4.37l5 3 5-3V6.13a2 2 0 0 0-.97-1.71l-3-1.8a2 2 0 0 0-2.06 0l-3 1.8Z">     </path>     <path d="M12 8 7.26 5.15"></path>     <path d="m12 8 4.74-2.85"></path> <path d="M12 13.5V8"></path></svg>',
            'idMessage' => '',
        ],
        [
            'name' => 'Các danh mục',
            'link' => '/categorys',
            'icon' =>
                ' <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg"> <path     d="M10 3H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zM9 9H5V5h4v4zm11-6h-6a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1zm-1 6h-4V5h4v4zm-9 4H4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1v-6a1 1 0 0 0-1-1zm-1 6H5v-4h4v4zm8-6c-2.206 0-4 1.794-4 4s1.794 4 4 4 4-1.794 4-4-1.794-4-4-4zm0 6c-1.103 0-2-.897-2-2s.897-2 2-2 2 .897 2 2-.897 2-2 2z"> </path> </svg>',
            'idMessage' => '',
        ],
        // [
        //     'name' => 'Đăng Xuất',
        //     'link' => '/login?isLogout=true',
        //     'icon' =>
        //         '<span>🔙</span>',
        //     'idMessage' => '',
        // ],
    ];
    $routePath = request()->path() == '/' ? '/' : '/' . request()->path();
@endphp
@foreach ($dataMenu as $key => $value)
    <li class="li-menu bg-opacity-10 {{ $routePath == $value['link'] ? ' italic font-semibold underline' : '' }} ">
        <a href="{{ $value['link'] }}">
            {!! $value['icon'] !!}
            {{ $value['name'] }}
            <span class="{{ $value['idMessage'] }} animate-bounce"></span>
        </a>
    </li>
@endforeach
<script>
    anime({
        targets: "#menu-dashboard .li-menu",
        scale: [0.2, 1],
        translateY: [-500, 0],
        opacity: [0, 1],
        easing: "easeOutQuad",
